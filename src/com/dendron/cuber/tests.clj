...
; This file is public domain, it's just a very messy  blob of executed code made during development
; that one passes to a live repl.
(comment
...
; attempt at the full algorithm the very slow way
